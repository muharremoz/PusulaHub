  ...
  return (
    <>
      <div className="rounded-[8px] p-2" style={{ backgroundColor: "var(--section-bg)" }}>
        ...
        >
          {/* Header */}
          <div className="grid grid-cols-[1fr_120px_160px_100px_100px_28px] gap-3 px-3 py-2 bg-muted/20 border-b border-border items-center">
            <span className="text-[10px] font-medium text-muted-foreground tracking-wider uppercase">Kullanıcı Adı</span>
            <span className="text-[10px] font-medium text-muted-foreground tracking-wider uppercase">Tür</span>
            <span className="text-[10px] font-medium text-muted-foreground tracking-wider uppercase">Giriş Saati</span>
            <span className="text-[10px] font-medium text-muted-foreground tracking-wider uppercase">Durum</span>
            <span className="text-[10px] font-medium text-muted-foreground tracking-wider uppercase">İstemci IP</span>
            <span />
          </div>
            ...
            <div className="divide-y divide-border/40">
              {sessions.map((ses, idx) => (
                ...
                >
                  ...
                  <span className={`text-[9px] px-1.5 py-0.5 rounded-[5px] font-medium w-fit ${ses.state === "Active" ? "bg-emerald-100 text-emerald-700 dark:text-emerald-400" : "bg-orange-100 text-orange-700 dark:text-orange-400"}`}>
