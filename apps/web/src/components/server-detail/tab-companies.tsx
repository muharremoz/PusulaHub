...
import { Building2, Users, MoreVertical, ChevronUp, ChevronDown, ChevronsUpDown, UserCheck, UserX, Shield } from "lucide-react";
          ...
          <ScrollArea className="flex-1">
            <div className="px-4 py-4">
              <div className="rounded-[5px] border border-border/50 overflow-hidden">
                ...
                {/* Table header */}
                <div className="grid grid-cols-[1fr_1fr_60px_28px] gap-3 px-3 py-2 bg-muted/20 border-b border-border/40 items-center">
                ...
                <div className="divide-y divide-border/40">
                  {selectedCompany?.users.map((user) => (
                    <div key={user.username}>
                      <div className="grid grid-cols-[1fr_1fr_60px_28px] gap-3 px-3 py-2.5 hover:bg-muted/20 transition-colors items-center">
                      ...
                      {user.groups && user.groups.length > 0 && (
                        <div className="flex items-center gap-1.5 px-3 pb-2 flex-wrap">
                          <Shield className="size-3 text-muted-foreground/50 shrink-0" />
                          {user.groups.map((g) => (
                            <span
                              key={g}
                              className="text-[9px] bg-muted px-1.5 py-0.5 rounded-[3px] font-medium text-muted-foreground"
                            >
                              {g}
                            </span>
                          ))}
