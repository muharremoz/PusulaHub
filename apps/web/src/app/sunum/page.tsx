...
const HERO_STATS: { label: string; num: number; suffix?: string; sub: string }[] = [
  ...
  { label: "Uygulama", num: 8,   sub: "Web · Masaüstü · Servis" },
...
const APPS: AppShowcase[] = [
  ...
  },
  {
    key:     "crm",
    name:    "Pusula CRM",
    tagline: "İç destek & müşteri yönetimi",
    color:   "from-orange-500/20 to-orange-500/0",
    accent:  "#fb923c",
    icon:    Headset,
    summary: "Pusula Yazılım iç ekibi için talep yönetimi, müşteri takibi ve performans raporlaması yapan web tabanlı helpdesk uygulaması. Destek, satış ve hesap yönetimi ekibinin müşteri firmalarla etkileşimini tek merkezi araçta toplar.",
    features: [
      { icon: LayoutDashboard, title: "Dinamik Dashboard",         desc: "KPI'lar, kişisel görevler, departman performansı ve sistem durumu tek ekranda." },
      { icon: Ticket,          title: "Talep Yönetimi",            desc: "Talep oluşturma, atama, durum izleme; öncelik ve kategori filtreleme." },
      { icon: Users,           title: "Müşteri Kartları",          desc: "Firma profilleri, iletişim kişileri, lisans ve hizmet bilgileri merkezi." },
      { icon: Building2,       title: "Şube Yönetimi",             desc: "Kurumsal müşterilerin çoklu şube, iletişim kişisi ve kullanıcı takibi." },
      { icon: AlertCircle,     title: "Bakım Yenileme Uyarısı",    desc: "Lisans/hizmet bitiş tarihlerini 30 gün öncesinden izle, kaçırma." },
      { icon: FileText,        title: "Teklif Yönetimi",           desc: "İnteraktif teklif oluşturucu, fiyat hesaplama ve müşteri kabul takibi." },
      { icon: Calendar,        title: "Takvim & Programlama",      desc: "Aylık takvim, etkinlik planlama ve ekip çizelgeleri." },
      { icon: ClipboardCheck,  title: "Görev Yönetimi",            desc: "İş görevleri oluştur, ata ve tamamlanma durumunu takip et." },
      { icon: Phone,           title: "Çağrı Geçmişi",             desc: "Cihaz bazlı arama kaydı ve arayan kimliği (Caller ID) entegrasyonu." },
      { icon: TrendingUp,      title: "Patron Raporu",             desc: "Aylık tahsilat, talep açılış/kapanış, personel performansı ve firma sıralaması." },
      { icon: BarChart3,       title: "Performans Analitiği",      desc: "Son 6 ay trend, çözüm hızı, müşteri aktivitesi ve döviz bazlı tahsilat." },
      { icon: MessageSquare,   title: "Notlar & Yorumlar",         desc: "Talep bazlı notlar, internal yorumlar ve aktivite geçmişi." },
    ],
  },
  {
    key:     "api",
